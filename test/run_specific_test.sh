...
colcon test --packages-select pairs_uav_trajectory_generation --ctest-args -R 'get_path_after_takeoff_service' --event-handlers console_direct+ console_stderr- console_start_end-
