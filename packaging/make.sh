#!/usr/bin/env bash
# Host entrypoint: build ros-noetic-uav-trajectory-generation_*.deb for pairs_uav_trajectory_generation.
...
IMAGE="pairs-uav-trajectory-generation-noetic-packaging"
