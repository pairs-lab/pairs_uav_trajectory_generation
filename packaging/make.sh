#!/usr/bin/env bash
# Host entrypoint: build ros-jazzy-uav-trajectory-generation_*.deb for pairs_uav_trajectory_generation.
...
IMAGE="pairs-uav-trajectory-generation-jazzy-packaging"
