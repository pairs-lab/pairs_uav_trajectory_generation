...
# dependency .debs from /prebuilt, then builds pairs_uav_trajectory_generation and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_uav_trajectory_generation/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_trajectory_generation
