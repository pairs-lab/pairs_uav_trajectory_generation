...
inline bool trajectoryToFile(const std::string &filename, const mav_trajectory_generation::Trajectory &trajectory) {
...
inline bool trajectoryFromFile(const std::string &filename, mav_trajectory_generation::Trajectory *trajectory) {
  mav_trajectory_generation::Segment::Vector segments;
